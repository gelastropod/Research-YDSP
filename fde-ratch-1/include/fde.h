...
#define FDE_HASH_STATE_BYTES 32u

typedef enum {
    FDE_HASH_BLAKE3 = 0,
    FDE_HASH_BLAKE2S_256 = 1,
    FDE_HASH_SHA3_256 = 2,
    FDE_HASH_SHA256 = 3,
    FDE_HASH_COUNT = 4
} fde_hash;
...
typedef enum {
    ...
    FDE_RATCHET_CTR_BLAKE2S_256 = 4,
    FDE_RATCHET_CTR_SHA3_256 = 5,
    FDE_RATCHET_CTR_SHA256 = 6,
    FDE_RATCHET_CBC_AES = 7,
    FDE_RATCHET_CBC_BLAKE3 = 8,
    FDE_RATCHET_CBC_BLAKE2S_256 = 9,
    FDE_RATCHET_CBC_SHA3_256 = 10,
    FDE_RATCHET_CBC_SHA256 = 11,
    FDE_SCHEME_COUNT = 12
} fde_scheme;
